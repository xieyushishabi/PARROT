...
class MegaTTS3DiTInfer():
    ...
    def build_model(self, device):
        ...
        # 为frames_multiple添加默认值8，避免KeyError
        if 'frames_multiple' not in hparams:
            print('Warning: frames_multiple not found in hparams, using default value 8')
        hp_dur_model['frames_multiple'] = hparams.get('frames_multiple', 8)
        ...
        print(f"Loading G2P model from {self.g2p_exp_name}")
        try:
